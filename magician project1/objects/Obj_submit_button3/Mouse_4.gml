    ...
    if (option_selected) {
        if (selected_count > 1) {
            ...
            if (option_false_selected) {
				...
				global.npcdespawn3 = true;

                show_message("Correct answer: the third digit is 2.");
        ...
        show_message("Por favor selecciona una opción.");
    }
}
