...
if (room_get_name(room) == "Room_question3") {
    ...
    draw_text(draw_x, draw_y, "Question 3 Days Of the week:");
    draw_text(draw_x, draw_y + line_height, "Which day comes after tuesday?");
    draw_text(draw_x, draw_y + 2 * line_height, "");
    draw_text(draw_x, draw_y + 3 * line_height, "a) Monday");
    draw_text(draw_x, draw_y + 4 * line_height, "b) Wednesday");
    draw_text(draw_x, draw_y + 5 * line_height, "c) Thursday");
