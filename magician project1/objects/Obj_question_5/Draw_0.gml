...
if (room_get_name(room) == "Room_question5") {
    ...
    draw_text(draw_x, draw_y, "Question 5 Pronouns:");
    draw_text(draw_x, draw_y + line_height, "What is the correct pronoun to replace");
    draw_text(draw_x, draw_y + 2 * line_height, "John and I in the sentence:");
    draw_text(draw_x, draw_y + 3 * line_height, "John and I are going to the park?");
    draw_text(draw_x, draw_y + 4 * line_height, "");
    draw_text(draw_x, draw_y + 5 * line_height, "a) They");
    draw_text(draw_x, draw_y + 6 * line_height, "b) We");
    draw_text(draw_x, draw_y + 7 * line_height, "c) Us");
